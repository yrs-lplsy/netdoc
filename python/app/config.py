...
# 服务账号(AGENT_SERVICE):Python 反向调用 Java 工具端点的服务凭证(spec §3.2)
AGENT_USERNAME = os.getenv("AGENT_USERNAME", "agent-service")
AGENT_PASSWORD = os.getenv("AGENT_PASSWORD", "agent-secret-123")
